...
namespace ConsoleAppCustomField
{
    class Program
    {

        // Project name to access
        private static String SampleProjectName = "PROYECTO TEST MOISES";

        private static ProjectContext projContext = new ProjectContext("https://aigpanama.sharepoint.com/sites/Proyectos-TI/");
